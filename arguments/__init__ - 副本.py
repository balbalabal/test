...
class ModelParams(ParamGroup): 
    def __init__(self, parser, sentinel=False):
        ...
        self.lod = 0
         ...
         # --- ↓↓↓ 新增 EC Transformer 结构参数 (默认值 0 表示关闭) ↓↓↓ ---
        self.ec_model_dim = 0  # Transformer 内部维度 (0 表示不创建)
        self.ec_nhead = 0  # 注意力头数
        self.ec_num_encoder_layers = 0  # Encoder 层数 (我们将使用 Encoder-Only)
        self.ec_dim_feedforward = 0  # FeedForward 网络维度
        self.ec_max_neighbors = 0  # 最大邻居数 (设为 0 表示关闭)
        self.ec_dropout = 0.0  # Dropout 比例
          # --- ↑↑↑ 新增结束 ↑↑↑ ---
...
# --- ↓↓↓ 新增 EC Transformer 学习率参数 ↓↓↓ ---
        self.ec_transformer_lr_init = 0.001
        self.ec_transformer_lr_final = 0.00001
        self.ec_transformer_lr_delay_mult = 0.01
        self.ec_transformer_lr_max_steps = 30_000
 # --- ↑↑↑ 新增结束 ↑↑↑ ---

 # --- ↓↓↓ 新增 阶段 2 加载参数 ↓↓↓ ---
        self.load_stage1_checkpoint = ""  # 用于阶段 2，指定阶段 1 训练好的 .pth 检查点路径
          # --- ↑↑↑ 新增结束 ↑↑↑ ---
